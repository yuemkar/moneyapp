                    ...
                    <div class="box-body">
                        <form role="form" method="post" action="post.php?p=save" enctype="multipart/form-data">
							...
							<div class="row">                                                              
                                <div class="form-group col-md-6">
                                    <label>Bakiye</label>
                                    <input type="text" class="form-control" name="amount" value="">TL
                                </div>
                            </div>                            
							<div class="row">
								<div class="form-group col-md-6">
                                    ...
                                    <select name="cat_id" class="form-control">
                                        <?php foreach ($categories as $category) { ?>
                                            <option value="<?php echo $category->id; ?>" <?php if ($cats==$category->id) echo 'selected';?>><?php echo $category->title; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
							</div>
