...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Gelir Ekle  
			<small>Gelir Ekleyebilirsiniz..</small>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title pull-left">GELİR</h3>
							          ...
							          <ul class="nav navbar-nav">
							            <li class="dropdown">
							              ...
							              <ul class="dropdown-menu" role="menu">
							                <li><a href="?p=ilist&date=buay">Bu Ay</a></li>
							                <li><a href="?p=ilist&date=son7">Son 7 Gün</a></li>
							                <li><a href="?p=ilist&date=gecay">Geçen Ay</a></li>
							                <li><a href="?p=ilist&date=buyil">Bu Yıl</a></li>
							                <li><a href="?p=ilist&date=gecyil">Geçen Yıl</a></li>
							                <li class="divider"></li>
								  ...
								  <form method="GET">
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								      	<input type="hidden" name="p" value="ilist">	
                            ...
                            <div class="box-body table-responsive no-padding">
                              <div class="row">
										...
										<div class="circle" style="background:<?php echo ($category->color == '') ? '#1DEA0D' :$category->color  ?>">
								             <p>
								                <a href="./post.php?p=add&c=1&cid=<?php echo $category->id; ?>" class="text-info"><?php echo $category->title; ?></a></br>
								                + <?php 
